...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-w!k&2mp0tw(=g8o484fuk1qei(&i=y7$%4y#0_zw@5^e-0*ku2')
...
ALLOWED_HOSTS = [
    'djangoweb-production-b611.up.railway.app',
    'localhost',
    '127.0.0.1',
]

CSRF_TRUSTED_ORIGINS = [
    'https://djangoweb-production-b611.up.railway.app',
]
